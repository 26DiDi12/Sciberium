...
document.getElementById('profile_btn_info').classList.add('active');
document.querySelector('.profile_info').classList.add('active');

document.getElementById('profile_btn_buy').addEventListener('click', function () {
    document.getElementById('profile_btn_buy').classList.add('active');
    document.querySelector('.profile_supp').classList.remove('active');
    document.querySelector('.profile_info').classList.remove('active');
    document.getElementById('profile_btn_info').classList.remove('active');
    document.getElementById('profile_btn_supp').classList.remove('active');
})
document.getElementById('profile_btn_info').addEventListener('click', function () {
    document.getElementById('profile_btn_info').classList.add('active');
    document.querySelector('.profile_info').classList.add('active');
    document.querySelector('.profile_supp').classList.remove('active');
    document.getElementById('profile_btn_buy').classList.remove('active');
    document.getElementById('profile_btn_supp').classList.remove('active');
})
document.getElementById('profile_btn_supp').addEventListener('click', function () {
    document.getElementById('profile_btn_supp').classList.add('active');
    document.querySelector('.profile_supp').classList.add('active');
    document.querySelector('.profile_info').classList.remove('active');
    document.getElementById('profile_btn_info').classList.remove('active');
    document.getElementById('profile_btn_buy').classList.remove('active');
})
